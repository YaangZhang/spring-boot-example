package com.sto.springbootwebsocket;
...
import static com.sto.springbootwebsocket.utils.WebSocketUtils.ONLINE_USER_SESSIONS;
import static com.sto.springbootwebsocket.utils.WebSocketUtils.sendMessageAll;
...
public class ChatRoomServerEndpoint {
    ...
    public void openSession(@PathParam("username") String name, Session session){
        ONLINE_USER_SESSIONS.put(name, session);
