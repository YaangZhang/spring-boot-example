...
//		System.out.println(MP3OUTPATH);
		...
		// 这里进行图片的处理
		// */
		// new Part().ComPicMP4(osNames, "D:/data/images/test-gif.gif", "D:/data/images/test-gif.mp4");//经过处理后的图片合成新的第二段视频
		// new Part().comGiftoMP4(osNames, "D:/data/images/test-gif.gif", "D:/data/images/test-gif2.ts");//经过处理后的图片合成新的第二段视频
		//
		...
		// new Part().changeTs(osNames, "D:/data/images/outputgif2.mp4", "D:/data/images/test-gif.ts");
		...
		// new Part().tsToMP4(osNames, shipin, "D:/data/images/05d6-new2.mp4");//拼接成新的MP4
