...
import static com.sto.quartz.push.AppInfo.*;
...
//        }
        ...
        try {
            ...
            System.out.println("pushMessageToApp ret: "+ ret);
//            ret = push.pushMessageToApp(message, "任务别名_toApp");
        } catch (PushAppException e) {
            e.printStackTrace();
        }
        if (ret != null) {
            System.out.println("pushMessageToApp ret.getResponse() : "+ret.getResponse().toString());
